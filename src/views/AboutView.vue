      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is <strong>Muhammad Fazry Al Gaza</strong>. I'm a web developer from <strong>Jakarta Timur</strong>. I'm a student at <strong>SMK Prestasi Prima</strong> and have already been involved in the world of programming for <strong>2 years</strong>. I really enjoy what I do right now. In my opinion, creating programs is not just a job, but also an art that has aesthetic value.
          </p>
  ...
  data() {
    return {
      ...
      tech: [
        ...
        { id: 4, name: 'Javascript', imageUrl: 'https://cdn.icon-icons.com/icons2/2415/PNG/512/javascript_original_logo_icon_146455.png', status: 'Advance' },
        { id: 5, name: 'Laravel', imageUrl: 'https://cdn.worldvectorlogo.com/logos/laravel-2.svg', status: 'Advance' },
        { id: 6, name: 'Codeigniter', imageUrl: '/img/codeigniter.png', status: 'Intermediate' },
        { id: 7, name: 'Python', imageUrl: '/img/python.png', status: 'Intermediate' },
        { id: 9, name: 'NodeJS', imageUrl: 'https://cdn.iconscout.com/icon/free/png-256/free-node-js-1174925.png', status: 'Beginner' },
