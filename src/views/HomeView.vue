<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Fazry Al Gaza</h1>
      <div class="py-2">
        <h1
      ...
      <a href="/files/CV M.Fazry.pdf" download
        class="fadein-bot fade-500 inline-flex items-center py-2 px-4 mt-2 text-sm font-medium rounded-lg border transition duration-300 text-amber-200 border-amber-200 hover:bg-amber-200 hover:bg-opacity-10 bg-transparent focus:outline-none w-fit mx-auto md:mx-0">
        <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
